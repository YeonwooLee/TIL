...
import hellojpa.pkMapping.MemberStretegyIdentity;
import hellojpa.pkMapping.MemberStretegySequence;
import hellojpa.pkMapping.MemberStretegyTable;
...
public class JpaMain {
    public static void main(String[] args) {
        ...
        tx.begin();
        try{
            MemberStretegyTable member2 = new MemberStretegyTable();
...
//        tx.begin();
//        try{
//            Member findMember = em.find(Member.class, 2L);//찾기

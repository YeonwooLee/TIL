...
### 시작시간:13:10 , 종료시간: 13:30(구상 소요 시간: 20)
...
>
>  implementation / bj / G2 / 240 / X / 21609 / 상어중학교
...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        while(true) {
//            System.out.println("새 턴 고=======================");
            //최대그룹찾기
            findMax();
            //최대그룹테스트
//            System.out.println("최대그룹 = "+maxGroup.size());
//            for(int[] arr:maxGroup){
...
- 무지개 방문처리 해제 안해서 한번 다른 숫자가 사용하면 다른 숫자가 사용 못하게됨

#### [느낀점]

- 아 그래도 코드 분리 잘 해놔서 찾을 수 있었다